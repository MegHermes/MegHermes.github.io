...
function pressJump(event) {
    if (
        ...
        gravAnim = null;
        document.getElementById('jumpSound').play(); // Play the jump sound
		...
		linkedin.animate(
			...
			linkedinLink.animate(
				...
				linkedinLink.addEventListener('click', function() {
					open('https://linkedin.com/in/meghermes/');
				});
			};
		};
	}
		...
		cv.animate(
			...
			cvLink.animate(
				...
				cvLink.addEventListener('click', function() {
					open('https://github.com/MegHermes/resume/blob/main/Megane_Hermes.pdf');
				});
			};
		};
	}
